            ...
            <form class="userform" method="post" action="">
                <fieldset>
                    ...
                    <ul>
                        ...
                        <input type="checkbox" name="ativo" <?php if(!isAdmin()) echo 'disabled="disabled"'; if($resbd->ativo == 's') echo 'checked="checked"'; ?> /> habilitar ou desabilitar o usuário</li>
                        <li><label for="adm">Administrador:</label>
                        <input type="checkbox" name="adm" <?php if(!isAdmin()) echo 'disabled="disabled"'; if($resbd->administrador == 's') echo 'checked="checked"'; ?> /> dar controle total ao usuário</li>
            ...
            <form class="userform" method="post" action="">
                <fieldset>
                    ...
                    <ul>
                        ...
                        <input type="text" disabled="disabled" size="35" name="login" value="<?php if($resbd) echo $resbd->login; ?>" /></li>
                        <li><label for="senha">Senha:</label>
                        <input type="password" size="25" name="senha" id="senha" autofocus="autofocus" value="<?php echo $_POST['senha'] ?>" /></li>
                        <li><label for="senhaconf">Repita a senha:</label>
                        <input type="password" size="25" name="senhaconf" value="<?php echo $_POST['senhaconf'] ?>" /></li>
            ...
            if (isset($_GET['id'])):
                ...
                if (isset($_POST['excluir'])):
                    ...
                    if ($user->linhasafetadas==1):
                        ...
                        printMSG('Nenhum registro foi excluído. <a href="?m=usuarios&t=listar">Exibir cadastros</a>','alerta');
                    endif;                   
                endif;
                $userbd = new usuarios();
                $userbd->extras_select = "WHERE id=$id";
            ...
            <form class="userform" method="post" action="">
                <fieldset>
                    ...
                    <ul>
                        ...
                        <input type="text" disabled="disabled" size="35" name="login" value="<?php if($resbd) echo $resbd->login; ?>" /></li>
                        <li><label for="ativo">Ativo:</label>
                        <input type="checkbox" disabled="disabled" name="ativo" <?php if($resbd->ativo == 's') echo 'checked="checked"'; ?> /> habilitar ou desabilitar o usuário</li>
                        <li><label for="adm">Administrador:</label>
                        <input type="checkbox" disabled="disabled" name="adm" <?php if($resbd->administrador == 's') echo 'checked="checked"'; ?> /> dar controle total ao usuário</li>
